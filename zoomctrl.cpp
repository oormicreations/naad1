...
void CZoomCtrl::Draw(CDC *pDC)
{
	...
	COLORREF backgrColor = RGB(255,255,225);
	...
	if(m_Error>0)
	{
		...
		errstr = L"Please ensure that :\r\n\r\n* Correct folder has been specified\r\n* Image file name contains the mobile number - page number (e.g. image9912345678-1.gif)\r\n* Image file is of supported format (Jpg,Gif,Png or Multipage Tif)\r\n\r\nSearched for : ";
